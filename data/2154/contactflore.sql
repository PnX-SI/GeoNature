...
CREATE FUNCTION synthese_delete_releve_cflore() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    idsource integer;
...
CREATE FUNCTION synthese_update_fiche_cflore() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    releves RECORD;
...
CREATE FUNCTION synthese_update_releve_cflore() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    test integer;
