...
echo "--------------------" &> log/install_contact_schema.log
echo "Create export contact view(s)" &>> log/install_contact_schema.log
echo "--------------------" &>> log/install_contact_schema.log
echo "" &>> log/install_contact_schema.log
export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/modules/contact/exports_contact.sql  &>> log/install_contact_schema.log
