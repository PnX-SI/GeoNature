...
# export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f $myrootpath/tmp/geonature/fr_departements.sql  &> $GEONATURE_ROOT/var/log/insert_departements.log
# export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f $GEONATURE_ROOT/data/core/ref_geo_departements.sql  &>> $myrootpath/var/log/insert_departements.log
