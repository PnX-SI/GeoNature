...
--      UNIQUEMENT POUR LES DONNÉES N'AYANT PAS DE SENSIBILITÉ DÉFINIE (c-a-d  id_nomenclature_sensitivity IS NULL)
...
-- Attention cela va calculer automatiquement la sensibilité à partir de la sensibilté
--      UNIQUEMENT POUR LES DONNÉES N'AYANT PAS DE NIVRAU DE DIFFUSION DÉFINI (c-a-d  id_diffusion_level IS NULL)
