...
--PNE
SELECT setval('gn_meta.sinp_datatype_protocols_id_protocol_seq', (SELECT max(id_protocol) FROM gn_meta.sinp_datatype_protocols), true);
...
SELECT setval('gn_meta.t_acquisition_frameworks_id_acquisition_framework_seq', (SELECT max(id_acquisition_framework) FROM gn_meta.t_acquisition_frameworks), true);
...
SELECT setval('gn_meta.t_datasets_id_dataset_seq', (SELECT max(id_dataset) FROM gn_meta.t_datasets), true);
UPDATE gn_meta.t_acquisition_frameworks SET id_nomenclature_territorial_level = ref_nomenclatures.get_id_nomenclature('NIVEAU_TERRITORIAL','1') WHERE id_acquisition_framework = 3;
