...
SELECT 
id_unite_geo,(SELECT id_type FROM ref_geo.bib_areas_types WHERE type_code = 'UG') AS id_type, concat('unite_geo_', id_unite_geo::text), id_unite_geo, the_geom, ST_Centroid(the_geom)
