...
AS SELECT s.id_synthese,
    ...
    s.count_min,
    s.count_max,
    s.nomCREATE OR REPLACE VIEW gn_synthese.v_synthese_for_web_app
AS SELECT s.id_synthese,
    s.unique_id_sinp,
    s.unique_id_sinp_grp,
    s.id_source,
   ...
   FROM gn_synthese.synthese s
     ...
     JOIN gn_meta.t_acquisition_frameworks f on f.id_acquisition_framework = d.id_acquisition_framework;_cite,
    s.meta_v_taxref,
    s.sample_number_proof,
    s.digital_proof,
    s.non_digital_proof,
