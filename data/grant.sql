...
REVOKE ALL ON TABLE geometry_columns FROM cartopnx;
GRANT ALL ON TABLE geometry_columns TO cartopnx;
...
REVOKE ALL ON TABLE geography_columns FROM cartopnx;
GRANT ALL ON TABLE geography_columns TO cartopnx;
...
REVOKE ALL ON TABLE spatial_ref_sys FROM cartopnx;
GRANT ALL ON TABLE spatial_ref_sys TO cartopnx;
