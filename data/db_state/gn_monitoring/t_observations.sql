...
CREATE TRIGGER trg_delete_synthese_observations AFTER DELETE ON gn_monitoring.t_observations FOR EACH ROW EXECUTE FUNCTION gn_synthese.fct_trg_delete_synthese_observations();
