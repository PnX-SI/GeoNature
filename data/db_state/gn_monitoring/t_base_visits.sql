...
CREATE TRIGGER trg_delete_synthese_visits AFTER DELETE ON gn_monitoring.t_base_visits FOR EACH ROW EXECUTE FUNCTION gn_synthese.fct_trg_delete_synthese_visits();
