...
(24, 'Unités géographiques', 'UG', 'Unités géographiques permettant une orientation des prospections', NULL, NULL),
(101, 'Communes', 'COM', 'Type commune', 'IGN admin_express',2017),
(102, 'Départements', 'DEP', 'Type département', 'IGN admin_express',2017),
(201, 'Mailles10*10', NULL, 'Type maille INPN 10*10km', NULL,NULL),
(202, 'Mailles1*1', NULL, 'Type maille INPN 1*1km', NULL,NULL),
