...
SELECT pg_catalog.setval('gn_monitoring.t_base_sites_id_base_site_seq', (SELECT max(id_base_site)+1 FROM gn_monitoring.t_base_sites), true);
...
SELECT pg_catalog.setval('gn_monitoring.t_base_visits_id_base_visit_seq', (SELECT max(id_base_visit)+1 FROM gn_monitoring.t_base_visits), true);
