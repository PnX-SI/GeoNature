...
,(102, 'RESOURCE_TYP', 'Type de ressources', 'Nomenclature des types de ressources relatifs aux jeux de données', 'SINP', 'Non validé', '2017-10-16 00:00:00', '2017-10-16 00:00:00')
...
,(108, 'OBJECTIFS', 'Objectif', 'Nomenclature des valeurs permises pour les objectifs du cadre d''acquisition.', 'SINP', 'Validé', '2017-10-30 00:00:00', '2017-10-30 00:00:00')
...
,(351, 102, '1', 'Dataset', 'Dataset', 'Jeu de données', 'SINP', 'non validé', 0, '102.001', '2017-10-16 16:05:18', NULL, true)
,(352, 102, '2', 'Series', 'Series', 'ensemble de séries de données', 'SINP', 'non validé', 0, '102.002', '2017-10-16 16:05:18', NULL, true)
,(353, 103, '1', 'DS', 'Données source', 'Jeu de données-source dans les bases de données d''un producteur ou Jeu de données-source transmises par un producteur à une plateforme régionale ou thématique', 'SINP', 'non validé', 0, '103.001', '2017-10-16 16:25:00', NULL, true)
,(354, 103, '2', 'DSR', 'Données source régionale', 'Jeu de données au standard régional dans la plateforme régionale/thématique', 'SINP', 'non validé', 0, '103.002', '2017-10-16 16:25:00', NULL, true)
,(355, 103, '3', 'DEE', 'Données élémentaires d''échange', 'Jeu de données élémentaires d''échange (échangé entre plateforme régionale ou thématique et plateforme nationale)', 'SINP', 'non validé', 0, '103.003', '2017-10-16 16:25:00', NULL, true)
,(356, 104, '1', 'Aléatoire simple', 'Aléatoire simple', 'Les tirages des unités sont équiprobables et indépendants)', 'SINP', 'non validé', 0, '104.001', '2017-10-16 17:15:00', NULL, true)
,(357, 104, '2', 'Systématique', 'Systématique', 'Les unités sont ordonnées (par ex. selon leurs coordonnées). Une première unité est tirée au hasard et les suivantes s''en déduisent en respectant l''agencement', 'SINP', 'non validé', 0, '104.002', '2017-10-16 17:15:00', NULL, true)
,(358, 104, '3', 'Stratifié', 'Stratifié', 'La zone d''étude est découpée en strates plus homogènes (selon les grands types de milieux par ex.), et les unités d''échantillonnage sont sélectionnées au sein de chaque strate selon un plan d''échantillonnage secondaire', 'SINP', 'non validé', 0, '104.003', '2017-10-16 17:15:00', NULL, true)
,(359, 104, '4', 'Adaptative sampling', 'Adaptative sampling', 'Tirage aléatoire d''un premier lot d''unités, puis de nouvelles unités sont ajoutées selon les résultats obtenus sur les premières', 'SINP', 'non validé', 0, '104.004', '2017-10-16 17:15:00', NULL, true)
,(360, 104, '5', 'Probabilités inégales', 'Probabilités inégales (distance sampling, relascope)', 'Le tirage des unités est aléatoire avec probabilités inégales (chaque unité d''échantillonnage n''a pas la même probabilité d''être sélectionnée). C''est souvent le cas pour des unités de taille variable', 'SINP', 'non validé', 0, '104.005', '2017-10-16 17:15:00', NULL, true)
,(361, 104, '6', 'Par degrés, par grappes', 'Par degrés, par grappes', 'La sélection des unités s''effectue dans un système hiérarchisé d''unités primaires, composées d''unités secondaires, etc. Par exemple, des arbres sont sélectionnés au sein de placettes, elles-mêmes sélectionnées au sein de peuplements forestiers, etc', 'SINP', 'non validé', 0, '104.006', '2017-10-16 17:15:00', NULL, true)
,(362, 104, '7', 'Subjectif', 'Subjectif', 'Le choix des unités d''échantillonnage est effectué selon des critères propres à l''observateur (pas toujours précisés)', 'SINP', 'non validé', 0, '104.007', '2017-10-16 17:15:00', NULL, true)
,(363, 104, '8', 'Autre', 'Autre', 'Autre type de plan d''échantillonnage', 'SINP', 'non validé', 0, '104.008', '2017-10-16 17:15:00', NULL, true)
,(364, 105, '1', 'Individus', 'Individus', 'Individus', 'SINP', 'non validé', 0, '105.001', '2017-10-16 17:15:00', NULL, true)
,(365, 105, '2', 'Points', 'Points', 'Points', 'SINP', 'non validé', 0, '105.002', '2017-10-16 17:15:00', NULL, true)
,(366, 105, '3', 'Quadrats', 'Quadrats', 'Surface impérativement carrée.', 'SINP', 'non validé', 0, '105.003', '2017-10-16 17:15:00', NULL, true)
...
,(380, 107, '1', 'International', 'International', 'niveau international', 'SINP', 'non validé', 0, '107.001', '2017-10-30 00:00:00', NULL, true)
,(381, 107, '2', 'Européen', 'Européen', 'niveau européen', 'SINP', 'non validé', 0, '107.002', '2017-10-30 00:00:00', NULL, true)
,(382, 107, '3', 'National', 'National', 'niveau national', 'SINP', 'non validé', 0, '107.003', '2017-10-30 00:00:00', NULL, true)
,(383, 107, '4', 'Inter-régional terrestre, ou région marine', 'Inter-régional terrestre, ou région marine', 'niveau inter-régional terrestre, ou région marine', 'SINP', 'non validé', 0, '107.004', '2017-10-30 00:00:00', NULL, true)
,(384, 107, '5', 'Régional terrestre, ou sous-région marine', 'Régional terrestre, ou sous-région marine', 'niveau régional terrestre, ou sous-région marine', 'SINP', 'non validé', 0, '107.005', '2017-10-30 00:00:00', NULL, true)
,(385, 107, '6', 'Départemental, ou secteur marin', 'Départemental, ou secteur marin', 'niveau départemental, ou secteur marin', 'SINP', 'non validé', 0, '107.006', '2017-10-30 00:00:00', NULL, true)
,(386, 107, '7', 'Communal ou local', 'Communal ou local', 'niveau communal ou local', 'SINP', 'non validé', 0, '107.007', '2017-10-30 00:00:00', NULL, true)
,(387, 108, '1', 'Inventaire espèce', 'Inventaire espèce', 'Inventaire espèce', 'SINP', 'non validé', 0, '108.001', '2017-10-30 00:00:00', NULL, true)
,(388, 108, '2', 'Inventaire habitat centré', 'Inventaire habitat centré', 'Inventaire habitat centré', 'SINP', 'non validé', 0, '108.002', '2017-10-30 00:00:00', NULL, true)
,(388, 108, '3', 'Inventaire logique espace', 'Inventaire logique espace', 'Inventaire logique espace', 'SINP', 'non validé', 0, '108.003', '2017-10-30 00:00:00', NULL, true)
,(389, 108, '4', 'Evaluation interaction', 'Evaluation interaction', 'Evaluation interaction', 'SINP', 'non validé', 0, '108.004', '2017-10-30 00:00:00', NULL, true)
,(390, 108, '5', 'Evolution temporelle', 'Evolution temporelle', 'Evolution temporelle', 'SINP', 'non validé', 0, '108.005', '2017-10-30 00:00:00', NULL, true)
,(391, 108, '6', 'Evolution espace', 'Evolution espace', 'Evolution espace', 'SINP', 'non validé', 0, '108.006', '2017-10-30 00:00:00', NULL, true)
,(392, 108, '7', 'Regroupements et autres études', 'Regroupements et autres études', 'Regroupements et autres études', 'SINP', 'non validé', 0, '108.007', '2017-10-30 00:00:00', NULL, true)
,(393, 109, '1', 'Contact principal', 'Contact principal', 'Contact principal', 'SINP', 'non validé', 0, '109.001', '2017-10-30 00:00:00', NULL, true)
,(394, 109, '2', 'Financeur', 'Financeur', 'Financeur', 'SINP', 'non validé', 0, '109.002', '2017-10-30 00:00:00', NULL, true)
,(395, 109, '3', 'Maître d''ouvrage', 'Maître d''ouvrage', 'Maître d''ouvrage', 'SINP', 'non validé', 0, '109.003', '2017-10-30 00:00:00', NULL, true)
,(396, 109, '4', 'Maître d''oeuvre', 'Maître d''oeuvre', 'Maître d''oeuvre', 'SINP', 'non validé', 0, '109.004', '2017-10-30 00:00:00', NULL, true)
,(397, 109, '5', 'Fournisseur du jeu de données', 'Fournisseur du jeu de données', 'Fournisseur du jeu de données', 'SINP', 'non validé', 0, '109.005', '2017-10-30 00:00:00', NULL, true)
,(398, 109, '6', 'Producteur du jeu de données', 'Producteur du jeu de données', 'Producteur du jeu de données', 'SINP', 'non validé', 0, '109.006', '2017-10-30 00:00:00', NULL, true)
,(399, 109, '7', 'Point de contact base de données de production', 'Point de contact base de données de production', 'Point de contact base de données de productions', 'SINP', 'non validé', 0, '109.007', '2017-10-30 00:00:00', NULL, true)
,(400, 110, 'METROP', 'Métropole', 'Métropole', 'Métropole', 'SINP', 'non validé', 0, '110.001', '2017-10-30 00:00:00', NULL, true)
,(401, 110, 'GUF', 'Guyane française', 'Guyane française', 'Guyane française', 'SINP', 'non validé', 0, '110.002', '2017-10-30 00:00:00', NULL, true)
,(402, 110, 'MTQ', 'Martinique', 'Martinique', 'Martinique', 'SINP', 'non validé', 0, '110.003', '2017-10-30 00:00:00', NULL, true)
,(403, 110, 'GLP', 'Guadeloupe', 'Guadeloupe', 'Guadeloupe', 'SINP', 'non validé', 0, '110.004', '2017-10-30 00:00:00', NULL, true)
,(404, 110, 'MAF', 'Saint-Martin', 'Saint-Martin', 'Saint-Martin', 'SINP', 'non validé', 0, '110.005', '2017-10-30 00:00:00', NULL, true)
,(405, 110, 'BLM', 'Saint-Barthélemy', 'Saint-Barthélemy', 'Saint-Barthélemy', 'SINP', 'non validé', 0, '110.006', '2017-10-30 00:00:00', NULL, true)
,(406, 110, 'SPM', 'Saint-Pierre et Miquelon', 'Saint-Pierre et Miquelon', 'Saint-Pierre et Miquelon', 'SINP', 'non validé', 0, '110.007', '2017-10-30 00:00:00', NULL, true)
,(407, 110, 'MYT', 'Mayotte', 'Mayotte', 'Mayotte', 'SINP', 'non validé', 0, '110.008', '2017-10-30 00:00:00', NULL, true)
,(408, 110, 'REU', 'Réunion', 'Réunion', 'Réunion', 'SINP', 'non validé', 0, '110.009', '2017-10-30 00:00:00', NULL, true)
,(409, 110, 'NCL', 'Nouvelle-Calédonie', 'Nouvelle-Calédonie', 'Nouvelle-Calédonie', 'SINP', 'non validé', 0, '110.010', '2017-10-30 00:00:00', NULL, true)
,(410, 110, 'WLF', 'Wallis-et-Futuna', 'Wallis-et-Futuna', 'Wallis-et-Futuna', 'SINP', 'non validé', 0, '110.011', '2017-10-30 00:00:00', NULL, true)
,(411, 110, 'PYF', 'Polynésie française', 'Polynésie française', 'Polynésie française', 'SINP', 'non validé', 0, '110.012', '2017-10-30 00:00:00', NULL, true)
,(412, 110, 'CLI', 'Clipperton', 'Clipperton', 'Clipperton', 'SINP', 'non validé', 0, '110.013', '2017-10-30 00:00:00', NULL, true)
,(413, 110, 'EPA', 'TAAF : Iles Eparses', 'TAAF : Iles Eparses', 'TAAF : Iles Eparses', 'SINP', 'non validé', 0, '110.014', '2017-10-30 00:00:00', NULL, true)
,(414, 110, 'SUBANT', 'TAAF : Iles sub-Antarctiques', 'TAAF : Iles sub-Antarctiques', 'TAAF : Iles sub-Antarctiques', 'SINP', 'non validé', 0, '110.015', '2017-10-30 00:00:00', NULL, true)
,(415, 110, 'TADL', 'TAAF : Terre-Adélie', 'TAAF : Terre-Adélie', 'TAAF : Terre-Adélie', 'SINP', 'non validé', 0, '110.016', '2017-10-30 00:00:00', NULL, true)
,(416, 110, 'HORSFR', 'Hors territoire', 'Hors territoire', 'Hors territoire', 'SINP', 'non validé', 0, '110.017', '2017-10-30 00:00:00', NULL, true)
,(417, 111, '1', 'Publique', 'Publique', 'Type de financement public', 'SINP', 'non validé', 0, '111.001', '2017-10-30 00:00:00', NULL, true)
,(418, 111, '2', 'Privée', 'Privée', 'Type de financement privé', 'SINP', 'non validé', 0, '111.002', '2017-10-30 00:00:00', NULL, true)
,(419, 111, '3', 'Mixte', 'Mixte', 'Mélange de financement public et privé', 'SINP', 'non validé', 0, '111.003', '2017-10-30 00:00:00', NULL, true)
,(420, 111, '4', 'Non financé', 'Non financé', 'Absence de financement', 'SINP', 'non validé', 0, '111.004', '2017-10-30 00:00:00', NULL, true)
,(421, 112, '0', 'Inconnu', 'Inconnu', 'Inconnu', 'SINP', 'non validé', 0, '112.017', '2017-10-30 00:00:00', NULL, true)
,(422, 112, '1', 'Protocole de collecte', 'Protocole de collecte', 'Protocole de collecte', 'SINP', 'non validé', 0, '1121.001', '2017-10-30 00:00:00', NULL, true)
,(423, 112, '2', 'Protocole de synthèse', 'Protocole de synthèse', 'Protocole de synthèse', 'SINP', 'non validé', 0, '112.002', '2017-10-30 00:00:00', NULL, true)
,(424, 112, '3', 'Protocole de conformité et de cohérence', 'Protocole de conformité et de cohérence', 'Protocole de conformité et de cohérence', 'SINP', 'non validé', 0, '111.003', '2017-10-30 00:00:00', NULL, true)
,(425, 112, '4', 'Protocole de validation', 'Protocole de validation', 'Protocole de validation', 'SINP', 'non validé', 0, '112.004', '2017-10-30 00:00:00', NULL, true)
,(426, 113, '1', 'Terre', 'Terre', 'Toutes les données relatives à la nature/biodiversité française du domaine terrestre (outre-mer compris) : habitats, flore, faune, champignons..., les données relatives aux espaces naturels (protégés / gérés ou non), aux sites géologiques, aux écosystèmes et leur fonctionnement.', 'SINP', 'non validé', 0, '113.001', '2017-10-30 00:00:00', NULL, true)
,(427, 113, '2', 'Mer', 'Mer', 'Toutes les données relatives à la nature / biodiversité française du domaine marin (outre-mer compris) : habitats, flore, faune, champignons..., les données relatives aux espaces naturels (protégés/gérés ou non), aux sites géologiques, aux écosystèmes et leur fonctionnement.', 'SINP', 'non validé', 0, '113.002', '2017-10-30 00:00:00', NULL, true)
,(428, 113, '3', 'Paysage', 'Paysage', 'Toutes les données relatives aux paysages, c''est-à-dire des données relatives aux formes du territoire, aux perceptions sociales et aux dynamiques du territoire. Elles intègrent également des inventaires particuliers. Elles concernent les espaces naturels, ruraux, urbains et périurbains. Elles incluent les espaces terrestres, les eaux intérieures et maritimes. Elles concernent tant les paysages pouvant être considérés comme remarquables que les paysages du quotidien et les paysages dégradés.', 'SINP', 'non validé', 0, '113.003', '2017-10-30 00:00:00', NULL, true)
;
