...
CREATE TABLE t_acquisition_frameworks (
    ...
    id_nomenclature_territorial_level integer DEFAULT get_default_nomenclature_value(107,1),
    territory_desc text,
    keywords text,
    id_nomenclature_financing_type integer DEFAULT get_default_nomenclature_value(111,1),
...
CREATE TABLE t_datasets (
    ...
    id_nomenclature_data_type integer NOT NULL DEFAULT get_default_nomenclature_value(103,1),
    keywords text,
    marine_domain boolean NOT NULL,
    terrestrial_domain boolean NOT NULL,
    id_nomenclature_dataset_objectif integer NOT NULL DEFAULT get_default_nomenclature_value(115,1),
    ...
    id_nomenclature_collecting_method integer NOT NULL DEFAULT get_default_nomenclature_value(114,1),
    id_nomenclature_data_origin integer NOT NULL DEFAULT get_default_nomenclature_value(2,1),
    id_nomenclature_source_status integer NOT NULL DEFAULT get_default_nomenclature_value(19,1),
    id_nomenclature_resource_type integer NOT NULL DEFAULT get_default_nomenclature_value(102,1),
