...
-- ;
-- SELECT pg_catalog.setval('sinp_datatype_actors_id_actor_seq', (SELECT max(id_actor) FROM gn_meta.sinp_datatype_actors), false);
...
;
SELECT pg_catalog.setval('sinp_datatype_protocols_id_protocol_seq', (SELECT max(id_protocol) FROM gn_meta.sinp_datatype_protocols), true);
