...
--             t_1.lb_nom
--            FROM taxonomie.taxref t_1
--           WHERE (t_1.lb_nom::text IN ( SELECT DISTINCT t_2.ordre
--                    FROM gn_synthese.synthese s
...
--              LEFT JOIN taxonomie.taxref cl ON cl.id_rang::text = 'CL'::text AND cl.cd_nom = cl.cd_ref AND cl.lb_nom::text = t_1.classe::text AND NOT t_1.classe IS NULL) t
--   ORDER BY t.id_regne, (COALESCE(t.id_embranchement, t.id_regne)), (COALESCE(t.id_classe, t.id_embranchement));
