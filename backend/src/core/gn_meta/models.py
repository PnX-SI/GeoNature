...
class TDatasets(serializableModel):
    ...
    id_organisme_owner = db.Column(db.Integer)
    id_organisme_producer = db.Column(db.Integer)
    id_organisme_administrator = db.Column(db.Integer)
    id_organisme_funder = db.Column(db.Integer)
