...
def upgrade():
    ...
    op.execute("CREATE UNIQUE INDEX index_vm_valid_profiles_cd_ref ON gn_profiles.vm_valid_profiles USING btree (cd_ref)")


def downgrade():
    op.execute("DROP INDEX gn_profiles.index_vm_valid_profiles_cd_ref")
    op.execute("CREATE INDEX index_vm_valid_profiles_cd_ref ON gn_profiles.vm_valid_profiles USING btree (cd_ref)")
