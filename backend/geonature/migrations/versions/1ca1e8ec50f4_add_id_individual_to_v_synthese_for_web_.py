"""add id_individual to v_synthese_for_web_app

Revision ID: 1ca1e8ec50f4
Revises: 4c9e74ffc27e
Create Date: 2026-08-05 11:51:15.932734
...
revision = "1ca1e8ec50f4"
down_revision = "4c9e74ffc27e"
branch_labels = None
depends_on = ("1d09a9b67970",)


def upgrade():

    with alter_table_with_dependent_views(op.get_bind(), "gn_synthese", "v_synthese_for_web_app"):
        op.execute("""
