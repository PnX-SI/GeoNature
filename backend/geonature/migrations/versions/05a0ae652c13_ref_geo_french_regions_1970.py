...
depends_on = (
    '3fdaa1805575',  # ref_geo_fr_departments
)
...
def upgrade():
    ...
    for params in [
                ...
                {'name': 'Auvergne', 'code': 83, 'deps': ['03', '15', '43', '63']},  # approximatif : 03 et 43 font partiellement partie de la région
                ...
                {'name': 'Midi-Pyrénées', 'code': 73, 'deps': ['9','12','31','32','46','65','81','82']},
                ...
                {'name': 'Rhône-Alpes', 'code': 82, 'deps': ['01','07','26','38','42','69','73','74']},
            ]:
