...
def upgrade():
    ...
    op.bulk_insert(bibNotificationsCategories,
        [
            {'code_notification_category': 'VALIDATION-1', 'label_notification_category': 'Modification du statut d\'une observation', 'description_notification_category': 'Categorie a utiliser en cas de modification d\'un statut d\'observation ' },
            {'code_notification_category': 'VALIDATION-2', 'label_notification_category': 'Suppresion d\'une observation', 'description_notification_category': 'Categorie a utiliser en cas de suppression d\'une observation' }
        ]
    )
    ...
    op.bulk_insert(bibNotificationsTemplates,
        [
            {'notification_template_category': 'VALIDATION-1', 'notification_template_method': 'MAIL', 'notification_template_content': '<p>Bonjour {{ name }}!</p><p>Le statut de l\'observation <a href="{{ url }}"></a>{{ observation }}</a> a été modifié.</p><p>Vous recevez ce mail via le service de notification de geonature</p>' }
        ]
    )
