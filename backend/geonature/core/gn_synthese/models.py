...
class Synthese(SyntheseCruved):
    ...
    cd_nomenclature_geo_object_nature = DB.Column(DB.Unicode)
    cd_nomenclature_grp_typ = DB.Column(DB.Unicode)
    cd_nomenclature_obs_meth = DB.Column(DB.Unicode)
    cd_nomenclature_obs_technique = DB.Column(DB.Unicode)
    cd_nomenclature_bio_status = DB.Column(DB.Unicode)
    cd_nomenclature_bio_condition = DB.Column(DB.Unicode)
    cd_nomenclature_naturalness = DB.Column(DB.Unicode)
    cd_nomenclature_exist_proof = DB.Column(DB.Unicode)
    cd_nomenclature_valid_status = DB.Column(DB.Unicode)
    cd_nomenclature_diffusion_level = DB.Column(DB.Unicode)
    cd_nomenclature_life_stage = DB.Column(DB.Unicode)
    cd_nomenclature_sex = DB.Column(DB.Unicode)
    cd_nomenclature_obj_count = DB.Column(DB.Unicode)
    cd_nomenclature_type_count = DB.Column(DB.Unicode)
    cd_nomenclature_sensitivity = DB.Column(DB.Unicode)
    cd_nomenclature_observation_status = DB.Column(DB.Unicode)
    cd_nomenclature_blurring = DB.Column(DB.Unicode)
    cd_nomenclature_source_status = DB.Column(DB.Unicode)
