...
def list_notification_rules():
    ...
    notificationsRules = TNotificationsRules.query.filter(TNotificationsRules.id_role == g.current_user.id_role)
    notificationsRules = notificationsRules.order_by(TNotificationsRules.code_notification_category.desc(), TNotificationsRules.code_notification_method.desc())
...
def delete_all_rules():
    ...
    nbRulesDeleted = TNotificationsRules.query.filter(TNotificationsRules.id_role == g.current_user.id_role).delete()
    DB.session.commit()
