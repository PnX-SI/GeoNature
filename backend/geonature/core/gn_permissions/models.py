...
from sqlalchemy.orm import foreign, joinedload, contains_eager, Mapped, mapped_column
...
class PermFilterType(db.Model):
    ...
    id_filter_type: Mapped[int] = mapped_column(db.Integer, primary_key=True)
    code_filter_type: Mapped[Optional[str]] = mapped_column(db.Unicode)
    label_filter_type: Mapped[Optional[str]] = mapped_column(db.Unicode)
    description_filter_type: Mapped[Optional[str]] = mapped_column(db.Unicode)
...
class PermScope(db.Model):
    ...
    __table_args__ = {"schema": "gn_permissions"}
    value: Mapped[int] = mapped_column(db.Integer, primary_key=True)
...
class PermAction(db.Model):
    ...
    __table_args__ = {"schema": "gn_permissions"}
    id_action: Mapped[int] = mapped_column(db.Integer, primary_key=True)
    code_action: Mapped[Optional[str]] = mapped_column(db.Unicode)
    description_action: Mapped[Optional[str]] = mapped_column(db.Unicode)
...
class PermObject(db.Model):
    ...
    __table_args__ = {"schema": "gn_permissions"}
    id_object: Mapped[int] = mapped_column(db.Integer, primary_key=True)
    code_object: Mapped[Optional[str]] = mapped_column(db.Unicode)
    description_object: Mapped[Optional[str]] = mapped_column(db.Unicode)
...
class PermissionAvailable(db.Model):
    ...
    scope_filter: Mapped[Optional[bool]] = mapped_column(db.Boolean, server_default=sa.false())
    sensitivity_filter: Mapped[bool] = mapped_column(db.Boolean, server_default=sa.false())
    areas_filter: Mapped[bool] = mapped_column(db.Boolean, server_default=sa.false())
    taxons_filter: Mapped[bool] = mapped_column(db.Boolean, server_default=sa.false())
...
class Permission(db.Model):
    ...
    id_permission: Mapped[int] = mapped_column(db.Integer, primary_key=True)
    id_role: Mapped[int] = mapped_column(db.Integer, ForeignKey("utilisateurs.t_roles.id_role"))
    id_action: Mapped[int] = mapped_column(db.Integer, ForeignKey(PermAction.id_action))
    ...
    scope_value: Mapped[Optional[int]] = mapped_column(db.Integer, ForeignKey(PermScope.value))
