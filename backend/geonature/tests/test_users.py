...
class TestUsers:
    ...
    def test_get_organisme_order_by(self, organisms):
        ...
        response = self.client.get(url_for("users.get_organismes"),
                                   query_string={'orderby': order_by_column})
    ...
    def test_get_role(self, users):
        ...
        response = self.client.get(url_for("users.get_role",
    ...
    def test_get_roles_order_by(self, users):
        response = self.client.get(url_for("users.get_roles"),
                                   query_string={'orderby': 'identifiant'})

        identifiants_resp = [resp['identifiant'] for resp in response.json]
        assert identifiants_resp.index(users['admin_user'].identifiant) < identifiants_resp.index(users['stranger_user'].identifiant)
    ...
    def test_get_organismes_jdd(self, users, datasets):
        ...
        assert users['admin_user'].organisme.nom_organisme in [org['nom_organisme'] for org in response.json]
    ...
    def test_get_organismes_jdd_no_dataset(self, users):
        ...
        assert users['admin_user'].organisme.nom_organisme not in [org['nom_organisme'] for org in response.json]
