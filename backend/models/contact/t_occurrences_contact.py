...
class T_OccurrencesContact(db.Model):
    ...
    __table_args__              = {'schema':'contact'}
    id_occurrence_contact       = db.Column(db.BigInteger, primary_key=True)
    id_obs_contact              = db.Column(db.BigInteger, nullable=False)
    id_nomenclature_meth_obs    = db.Column(db.Integer, nullable=False)
    id_nomenclature_eta_bio     = db.Column(db.Integer, nullable=False)
    id_nomenclature_statut_bio  = db.Column(db.Integer)
    id_nomenclature_naturalite  = db.Column(db.Integer)
    id_nomenclature_preuve_exist = db.Column(db.Integer)
    id_nomenclature_statut_obs  = db.Column(db.Integer)
    id_nomenclature_statut_valid = db.Column(db.Integer)
    id_nomenclature_niv_precis  = db.Column(db.Integer)
    id_valideur                 = db.Column(db.Integer, nullable=False)
    determinateur               = db.Column(db.Text)
    methode_determination       = db.Column(db.Text)
    ...
    def find_by_id(cls, id):
        return cls.query.filter_by(id_occurrence_contact=id).first()
