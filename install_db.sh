...
then
    ...
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/synthese_2154.sql  &>> log/install_db.log

    echo "Insertion des données des tables dictionnaires de la base..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/data_synthese_2154.sql  &>> log/install_db.log

    echo "Création des schémas des modules..."
    echo "      ...schéma contact faune..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/contactfaune.sql  &>> log/install_db.log

    echo "      ...schéma contact flore..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/contactflore.sql  &>> log/install_db.log

    echo "      ...schéma contact invertébré..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/contactinv.sql  &>> log/install_db.log

    echo "      ...schéma flore station..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/florestation.sql  &>> log/install_db.log

    echo "      ...schéma flore patri..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/florepatri.sql  &>> log/install_db.log

    echo "      ...schéma bryophytes..."
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/bryophytes.sql  &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h $db_host -U $user_pg -d $db_name -f data/2154/nomade.sql  &>> log/install_db.log
