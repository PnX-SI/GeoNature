...
then
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/apb.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/bios.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/cdl.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/cen.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/pn.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/pnm.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/pnr.sql &>> log/install_db.log
    echo "...Sites Ramsar..."
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/ramsar.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/rb.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/ripn.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/rnc.sql &>> log/install_db.log
    echo "...Réserves naturelles de Corse..."
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/rncfs.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/rnn.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/rnr.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/sic.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/zico.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/znieff1.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/znieff2.sql &>> log/install_db.log
    echo "...ZNIEFF 1 mer..."
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/znieff1_mer.sql &>> log/install_db.log
    echo "...ZNIEFF 2 mer..."
    ...
    export PGPASSWORD=$user_pg_pass;psql -h databases -U $user_pg -d $db_name -f data/layers/sql/znieff2_mer.sql &>> log/install_db.log
    ...
    export PGPASSWORD=$admin_pg_pass;psql -h databases -U $admin_pg -d $db_name -f data/2154/data_set_synthese_2154.sql  &>> log/install_db.log
