 ...
 * @method string              get()                  Returns the current record's "id_sophie" value
 ...
 * @method integer             get()                  Returns the current record's "meso_longitudinal" value
 * @method integer             get()                  Returns the current record's "meso_lateral" value
 * @method decimal             get()                  Returns the current record's "canopee" value
 * @method integer             get()                  Returns the current record's "ligneux_hauts" value
 * @method integer             get()                  Returns the current record's "ligneux_bas" value
 * @method integer             get()                  Returns the current record's "ligneux_tbas" value
 * @method integer             get()                  Returns the current record's "herbaces" value
 * @method integer             get()                  Returns the current record's "mousses" value
 * @method integer             get()                  Returns the current record's "litiere" value
 ...
 * @method BibExpositions      get()                  Returns the current record's "BibExpositions" value
 * @method BibHomogenes        get()                  Returns the current record's "BibHomogenes" value
 * @method BibProgrammesFs     get()                  Returns the current record's "BibProgrammesFs" value
 ...
 * @method BibSurfaces         get()                  Returns the current record's "BibSurfaces" value
 * @method CorFsTaxon          get()                  Returns the current record's "CorFsTaxon" value
 * @method LCommunes           get()                  Returns the current record's "LCommunes" value
 * @method Doctrine_Collection get()                  Returns the current record's "CorFsDelphine" collection
 ...
 * @method TStationsFs         set()                  Sets the current record's "id_station" value
 * @method TStationsFs         set()                  Sets the current record's "id_exposition" value
 * @method TStationsFs         set()                  Sets the current record's "id_sophie" value
 * @method TStationsFs         set()                  Sets the current record's "id_programme_fs" value
 * @method TStationsFs         set()                  Sets the current record's "id_protocole" value
 * @method TStationsFs         set()                  Sets the current record's "id_lot" value
 * @method TStationsFs         set()                  Sets the current record's "id_organisme" value
 * @method TStationsFs         set()                  Sets the current record's "id_support" value
 * @method TStationsFs         set()                  Sets the current record's "id_homogene" value
 * @method TStationsFs         set()                  Sets the current record's "id_surface" value
 * @method TStationsFs         set()                  Sets the current record's "dateobs" value
 * @method TStationsFs         set()                  Sets the current record's "info_acces" value
 * @method TStationsFs         set()                  Sets the current record's "complet_partiel" value
 * @method TStationsFs         set()                  Sets the current record's "meso_longitudinal" value
 * @method TStationsFs         set()                  Sets the current record's "meso_lateral" value
 * @method TStationsFs         set()                  Sets the current record's "canopee" value
 * @method TStationsFs         set()                  Sets the current record's "ligneux_hauts" value
 * @method TStationsFs         set()                  Sets the current record's "ligneux_bas" value
 * @method TStationsFs         set()                  Sets the current record's "ligneux_tbas" value
 * @method TStationsFs         set()                  Sets the current record's "herbaces" value
 * @method TStationsFs         set()                  Sets the current record's "mousses" value
 * @method TStationsFs         set()                  Sets the current record's "litiere" value
 * @method TStationsFs         set()                  Sets the current record's "altitude_saisie" value
 * @method TStationsFs         set()                  Sets the current record's "altitude_sig" value
 * @method TStationsFs         set()                  Sets the current record's "altitude_retenue" value
 * @method TStationsFs         set()                  Sets the current record's "remarques" value
 * @method TStationsFs         set()                  Sets the current record's "pdop" value
 * @method TStationsFs         set()                  Sets the current record's "the_geom_local" value
 * @method TStationsFs         set()                  Sets the current record's "the_geom_3857" value
 * @method TStationsFs         set()                  Sets the current record's "srid_dessin" value
 * @method TStationsFs         set()                  Sets the current record's "supprime" value
 * @method TStationsFs         set()                  Sets the current record's "date_insert" value
 * @method TStationsFs         set()                  Sets the current record's "date_update" value
 * @method TStationsFs         set()                  Sets the current record's "insee" value
 * @method TStationsFs         set()                  Sets the current record's "validation" value
 * @method TStationsFs         set()                  Sets the current record's "BibExpositions" value
 * @method TStationsFs         set()                  Sets the current record's "BibHomogenes" value
 * @method TStationsFs         set()                  Sets the current record's "BibProgrammesFs" value
 * @method TStationsFs         set()                  Sets the current record's "BibSupports" value
 * @method TStationsFs         set()                  Sets the current record's "BibOrganismes" value
 * @method TStationsFs         set()                  Sets the current record's "BibLots" value
 * @method TStationsFs         set()                  Sets the current record's "TProtocoles" value
 * @method TStationsFs         set()                  Sets the current record's "BibSurfaces" value
 * @method TStationsFs         set()                  Sets the current record's "CorFsTaxon" value
 * @method TStationsFs         set()                  Sets the current record's "LCommunes" value
 * @method TStationsFs         set()                  Sets the current record's "CorFsDelphine" collection
 * @method TStationsFs         set()                  Sets the current record's "CorFsMicrorelief" collection
 * @method TStationsFs         set()                  Sets the current record's "CorFsObservateur" collection
 * 
 * @package    geonature
 * @subpackage model
