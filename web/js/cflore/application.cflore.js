...
Ext.namespace("application.cflorelore");
    ...
    */
    ...
    return {
        ...
        ,ziva: function() {
            ...
            Ext.Ajax.request({
                ...
                ,success: function(request) {
                    ...
                    application.cflore.editFiche.loadFiche(null,'add',null);
                }
                ,failure: function() {
        ...
        ,init:function(){
            ...
            if (checkApiLoading('application.cflore.init();',['OpenLayers','Geoportal','Geoportal.Catalogue'])===false) {
                return;
            }
        ...
        ,createMap: function() {
            ...
            var overlay = new OpenLayers.Layer.WMS("overlay",
                ...
                ,{
                    ...
                    ,maxResolution: resolution_max
                    ,maxExtent: extent_max
                    ,statuscode: application.cflore.user.statuscode
                }
                ,{singleTile: true}
            );
        ...
        ,getFeature: function(geom) {
            var v = application.cflore.searchVectorLayer;
...
Ext.namespace("application.cflore.utils");
 ...
 */
application.cflore.utils.addSeparator = function(toolbar) {
