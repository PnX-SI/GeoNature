...
application.invertebre = function() {
    /**
    * Property: formatWKT
    */
    ...
    */
    ...
    return {
        ...
        ,ziva: function() {
            ...
            Ext.Ajax.request({
                ...
                ,success: function(request) {
                    ...
                    application.invertebre.editFiche.loadFiche(null,'add',null)
                }
                ,failure: function() {
        ...
        ,init:function(){
            ...
            if (checkApiLoading('application.invertebre.init();',['OpenLayers','Geoportal','Geoportal.Catalogue'])===false) {
                return;
            }
        ...
        ,createMap: function() {
            ...
            var overlay = new OpenLayers.Layer.WMS("overlay",
                ...
                ,{
                    ...
                    ,maxResolution: resolution_max
                    ,maxExtent: extent_max
                    ,statuscode: application.invertebre.user.statuscode
                }
                ,{singleTile: true}
            );
        ...
        ,getFeature: function(geom) {
            var v = application.invertebre.searchVectorLayer;
...
Ext.namespace("application.invertebre.utils");
 ...
 */
application.invertebre.utils.addSeparator = function(toolbar) {
