...
application.invertebre.editFiche = function() {
    ...
    var getFormTaxons = function(){
        ...
        var comboTaxonsFiltreClasse = function(classe){
            ...
            if(gasteropodes && classe==id_classe_gasteropodes){
                return true;
            }
            return false;
        };
        ...
        var isValidForm = function(){
            ...
            Ext.getCmp('grid-taxons').getStore().each(function(r){
                ...
                if((r.data.am+r.data.af+r.data.ai+r.data.na) == 0){
        ...
        var isValidTaxon = function(r){
            ...
            errorMsg = '';
                ...
                if(r.data.id_critere_inv==0 || r.data.id_critere_inv==null){
                    isValid = false;
                    errorMsg='Veuillez choisir un critère pour ce taxon';
                }
                if((r.data.am+r.data.af+r.data.ai+r.data.na) == 0){
                    isValid = false;
                }
        ...
        var manageValidationTaxon = function(isValid){
            if(isValid){
                ...
                if(!Ext.getCmp('grid-taxons').getSelectionModel().hasNext() && Ext.getCmp('grid-taxons').getSelectionModel().getSelected().data.id_nom==null){
                    ...
                    Ext.getCmp('grid-taxons').disable();
                }
