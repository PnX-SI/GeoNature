            ...
            ,items :[
                {
                    ...
                    ,tpl: '<tpl for="."><div class="x-combo-list-item" style="<tpl if="patrimonial">font-weight:bold</tpl>" ><img src="images/classe{id_liste}.gif" width=20 height=20/> {nom_francais}</div></tpl></tpl>'
                    ...
                    ,tpl: '<tpl for="."><div class="x-combo-list-item" style="<tpl if="patrimonial">font-weight:bold</tpl>" ><img src="images/classe{id_liste}.gif" width=20 height=20/> {nom_latin}</div></tpl></tpl>'
