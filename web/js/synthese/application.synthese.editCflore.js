/**
 * @class application.synthese.editCflore
...
application.synthese.editCflore = function() {
    // private variables
    // "use strict";
    /**
     * Property: map
    ...
    var initWindow = function() {
        return new Ext.Window({
            id:'window-form'
            ,title: "Modifier une fiche contact Flore"
            ,layout: 'border'
            ,modal: true
            ,plain: true
    ...
    var getFormItems = function() { 
        var comboObservateurs = new Ext.ux.form.SuperBoxSelect({
            ...
            ,store: application.synthese.storeObservateursCfloreAdd
            ,displayField: 'auteur'
            ,valueField: 'id_role'
            ,allowBlank: false
            ,resizable: true
        ...
        var gridForm = new Ext.Panel({
            ...
            ,items: [{
                ...
                ,items: [
                {
                    ...
                    ,columnWidth: 1
                    ,title: label_validite
                    ,collapsible: true
                    ,collapsed: true
                    ,hidden:!(application.synthese.user.statuscode >= 5 && use_validite_cflore)
                    ,autoHeight:true
                    ,anchor:'100%'
                    ,items :[
                        {
                            ...
                            rowselect: function(sm, row, rec) {
                                ...
                                if(rec.data.nom_taxon_saisi=='Saisie en cours'){
                                    if(Ext.getCmp('combo-fiche-taxon').getValue()==null){
                                        ...
                                        Ext.getCmp('fieldset-abondance').expand();
                                        Ext.getCmp('combo-fiche-abondance').setWidth(200);//debug sinon le combo apparait avec une largeur ridicule
                                        Ext.getCmp('combo-fiche-abondance').syncSize();
                                    }
                                    if(Ext.getCmp('combo-fiche-abondance').getValue()==null){
                                        ...
                                        Ext.getCmp('fieldset-phenologie').expand();
                                        Ext.getCmp('combo-fiche-phenologie').setWidth(200);//debug sinon le combo apparait avec une largeur ridicule
                                        Ext.getCmp('combo-fiche-phenologie').syncSize();
                                        Ext.getCmp('fieldset-validite').expand();
    ...
    var createLayer = function() {
        ...
        vectorLayer = new OpenLayers.Layer.Vector("editCflore vector layer"
            ,{
        ...
        vectorLayer.events.on({
            featureadded: function(obj) {
                ...
                if(!firstAltitudeLoad){application.synthese.editCflore.findZ(feature);}
        ...
        if (!toolbarInitializedOnce) {
            ...
            toolbar.add({
                ...
                ,handler: function() {
                    ...
                    application.synthese.editCflore.initGpsWindow();
                }
            });
    ...
    var submitForm = function() {
        ...
        Ext.getCmp('edit-fiche-form').getForm().submit({
            ...
            ,success: function(form,action) {
                ...
                toolbarInitializedOnce = false;
                application.synthese.editCflore.window.destroy();
            }
    ...
    return {
        ...
        ,loadFiche: function(fiche,action,cd) {
            ...
            if (action=='update') {
                ...
                this.window.setTitle('Modification d\'une observation contact flore');
                if (fiche) {
                    id_cflore = fiche;
        ...
        ,findZ : function(feature) {
            ...
            script.src = String.format('//wxs.ign.fr/{0}/alti/rest/elevation.xml?lon={1}&lat={2}&output=json&zonly=true&callback=application.synthese.editCflore.handleIGNResponse', ign_api_key, latLonGeom.x, latLonGeom.y);
        ...
        ,handleIGNResponse : function(data) {
            ...
            application.synthese.editCflore.setAltitude(Math.round(s[0].innerHTML));
        }
