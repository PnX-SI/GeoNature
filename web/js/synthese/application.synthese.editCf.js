...
application.synthese.editCf = function() {
    ...
    var getFormTaxons = function(){
        ...
        myProxyTaxons = new Ext.data.HttpProxy({
            ...
            ,url: 'bibs/taxonscf'
            // ,url: 'bibs/taxonscfu?point=POINT(462648 5003392)'
            ,method: 'GET'
        });
        ...
        storeTaxonsCf = new Ext.data.JsonStore({
            ...
            ,listeners: {
                load: function(store, records) {
                    ...
                    comboTaxonsFiltre();
                    // Ext.getCmp('combo-fiche-taxon').update();
                }
            }
        });
    ...
    var createLayer = function() {
        ...
        vectorLayer.events.on({
            featureadded: function(obj) {
                ...
                // if(Ext.getCmp('edit-fiche-form').getForm().findField('monaction').getValue() =='add'){application.synthese.editCf.findZ();}
