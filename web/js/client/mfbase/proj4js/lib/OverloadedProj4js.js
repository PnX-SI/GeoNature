 ...
 */
    ...
    Proj4js.setProxyUrl= function(url) {
        ...
        Proj4js.ProxyHostFQDN= Proj4js.getFQDNForUrl(url);
    };
    ...
    Proj4js.loadScript= function(url, onload, onfail, loadCheck) {
      ...
      request.transport.onreadystatechange = Proj4js.bind(Proj4js.onStateChange,Proj4js,request);
      var headers= {
