...
/**
  ...
  var formatWKT = new OpenLayers.Format.WKT();
    return {
        ...
        ,auteursStoreFs: new Ext.data.JsonStore({
        ...
        ,homogeneStore: new Ext.data.JsonStore({
            url: 'bibs/homogenes'
            ,fields: [
                'id_homogene'
                ,'nom_homogene'
        ...
        ,microreliefStore: new Ext.data.JsonStore({
            ...
            ,sortInfo: {
                field: 'nom_microrelief'
                ,direction: 'ASC'
            }
            ,autoLoad: true
        })
        ,programmeStore: new Ext.data.JsonStore({
        ...
        ,surfaceStore: new Ext.data.JsonStore({
            url: 'bibs/surfaces'
            ,fields: [
                'id_surface'
                ,'nom_surface'
        ...
        ,sophieStore: new Ext.data.JsonStore({
            url: 'bibs/sophie'
            ,fields: [
                {name:'id_sophie',type:'string'}
            ]
            ,sortInfo: {
                field: 'id_sophie'
                ,direction: 'ASC'
