...
- [Occtax] Correction d'un lien vers la page d’accueil dans un contexte de module dupliqué de Occtax (#3610)
- [Discussion] Correction de l'affichage de l'auteur dans le bloc d'accueil (#3618 par @TheoLechemia)
- [Synthèse] Correction des statistiques calculées dans la fiche taxon si une observation n'est pas associée à une commune (#3631 par @Pierre-Narcisi)
- [Synthèse] Les filtres de status avec une seul valeur ne sont plus cochés par défaut (#3624 par @jacquesfize)
- [Validation] Correction du lien généré dans la notification par mail (#3623 par @jacquesfize)
- [Général] Correction permettant un chargement des médias asynchrone dans le component `pnx-medias` (#3636 par @amandine-sahl)
