...
* Intégration des régions par défaut lors de l'installation de GeoNature
* Amélioration des composants frontend DynamicForm
* Possibilité de filtrer le composant frontend "nomenclature" par règne ou Goup2INPN
