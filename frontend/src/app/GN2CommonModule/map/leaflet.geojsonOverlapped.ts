...
export class GeoJSONOverlapped extends L.GeoJSON {
  ...
  - line
  - point
  a global FeatureGroup (globalFeatureGroup) which contains the three other is available as object attribute 
  (usefull if we want to fitbound to all layers or remove all layer at once)
  */
