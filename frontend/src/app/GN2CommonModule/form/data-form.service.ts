...
export class DataFormService {
  ...
  getNomenclature(
    ...
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/nomenclatures/nomenclature/${codeNomenclatureType}`,
      { params: params }
    );
  }
  ...
  getNomenclatures(codesNomenclatureType: Array<string>) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/nomenclatures/nomenclatures`, {
      params: params,
    });
  }
  ...
  getDefaultNomenclatureValue(path, mnemoniques: Array<string> = [], kwargs: ParamsDict = {}) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/${path}/defaultNomenclatures`, {
      params: queryString,
    });
  }
  ...
  getDatasets(params?: ParamsDict, orderByName = true, fields = []) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/meta/datasets`, {
      params: queryString,
    });
  }
  ...
  //   return this._http.get<any>(
  //     `${this.cs.API_ENDPOINT}/meta/af_datasets_metadata`,
  //     { params: queryString }
  //   );
  // }

  getObservers(idMenu) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/users/menu/${idMenu}`);
  }

  getObserversFromCode(codeList) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/users/menu_from_code/${codeList}`);
  }
  ...
  getTaxonInfo(cd_nom: number, areasStatus?: Array<string>) {
    ...
    return this._http.get<Taxon>(`${this.cs.API_TAXHUB}/taxref/${cd_nom}`, {
      params: query_string,
    });
  }
  ...
  getTaxonAttributsAndMedia(cd_nom: number, id_attributs?: Array<number>) {
    ...
    return this._http.get<any>(`${this.cs.API_TAXHUB}/bibnoms/taxoninfo/${cd_nom}`, {
      params: query_string,
    });
  }

  getTaxaBibList() {
    return this._http.get<any>(`${this.cs.API_TAXHUB}/biblistes/`).pipe(map((d) => d.data));
  }

  async getTaxonInfoSynchrone(cd_nom: number): Promise<any> {
    const response = await this._http
      .get<Taxon>(`${this.cs.API_TAXHUB}/taxref/${cd_nom}`)
      .toPromise();
    return response;
  }
  ...
  getHigherTaxa(rank: string, search?) {
    ...
    let url = `${this.cs.API_TAXHUB}/taxref/search/lb_nom`;
    if (search) {
      url = `${url}/${search}`;
    }
  ...
  getRegneAndGroup2Inpn() {
    return this._http.get<any>(`${this.cs.API_TAXHUB}/taxref/regnewithgroupe2`);
  }

  getTaxhubBibAttributes() {
    return this._http.get<any>(`${this.cs.API_TAXHUB}/bibattributs/`);
  }

  getTaxonomyHabitat() {
    return this._http.get<any>(`${this.cs.API_TAXHUB}/taxref/bib_habitats`);
  }
  ...
  getTypologyHabitat(id_list: number) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/habref/typo`, { params: params }).pipe(
      map((data) => {
  ...
  getHabitatInfo(cd_hab) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/habref/habitat/${cd_hab}`);
  }

  getGeoInfo(geojson) {
    return this._http.post<any>(`${this.cs.API_ENDPOINT}/geo/info`, geojson);
  }
  ...
  getGeoIntersection(geojson, idType?) {
    ...
    return this._http.post(`${this.cs.API_ENDPOINT}/geo/areas`, geojson);
  }

  getAltitudes(geojson) {
    return this._http.post<any>(`${this.cs.API_ENDPOINT}/geo/altitude`, geojson);
  }
  ...
  getFormatedGeoIntersection(geojson, idType?) {
    ...
    return this._http.post(`${this.cs.API_ENDPOINT}/geo/areas`, geojson).pipe(
      map((res) => {
  ...
  getAreaSize(geojson) {
    return this._http.post<number>(`${this.cs.API_ENDPOINT}/geo/area_size`, geojson);
  }
  ...
  getMunicipalities(nom_com?, limit?) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/geo/municipalities`, { params: params });
  }
  ...
  getAreas(area_type_list: Array<string>, area_name?) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/geo/areas`, { params: params });
  }

  getAreasTypes() {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/geo/types`);
  }
  ...
  autocompleteRefGeo(params) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/geo/areas`, {
      params: queryString,
    });
  }
  ...
  getValidationHistory(uuid_attached_row) {
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/gn_commons/history/${uuid_attached_row}`,
      {}
    );
  }
  ...
  getAcquisitionFrameworks(params = {}) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/meta/list/acquisition_frameworks`, {
      params: queryString,
    });
  }
  ...
  getAcquisitionFrameworksList(selectors = {}, params = {}) {
    ...
    return this._http.post<any>(`${this.cs.API_ENDPOINT}/meta/acquisition_frameworks`, params, {
      params: queryString,
    });
  }
  ...
  getAcquisitionFramework(id_af, params?: ParamsDict) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/meta/acquisition_framework/${id_af}`, {
      params: queryString,
    });
  }
  ...
  getOrganisms(orderByName = true) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/users/organisms`, {
      params: queryString,
    });
  }
  ...
  getOrganismsDatasets(orderByName = true) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/users/organisms_dataset_actor`, {
      params: queryString,
    });
  }
  ...
  getDataset(id) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/meta/dataset/${id}`);
  }

  // getTaxaDistribution(id_dataset) {
  //   return this._http.get<any>(`${this.cs.API_ENDPOINT}/synthese/dataset_taxa_distribution/${id_dataset}`);
  // }
  getGeojsonData(id) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/meta/geojson_data/${id}`);
  }

  getRepartitionTaxons(id_dataset) {
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/synthese/repartition_taxons_dataset/${id_dataset}`
    );
  }
  ...
  getTaxaDistribution(taxa_rank, params?: ParamsDict) {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/synthese/taxa_distribution`, {
      params: queryString,
    });
  }
  ...
  getModulesList(exclude: Array<string> = []): Observable<Array<any>> {
    ...
    return this._http.get<Array<any>>(`${this.cs.API_ENDPOINT}/gn_commons/modules`, {
      params: queryString,
    });
  }
  ...
  getModuleByCodeName(module_code): Observable<any> {
    ...
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/gn_commons/modules/${module_code}`);
  }
  ...
  getDataList(api: string, application: string, params = {}) {
    ...
    const url =
      application === 'GeoNature'
        ? `${this.cs.API_ENDPOINT}/${api}`
        : application === 'TaxHub'
        ? `${this.cs.API_TAXHUB}/${api}`
        : api;
  ...
  //liste des lieux
  getPlaces() {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/gn_commons/places`);
  }
  //Ajouter lieu
  addPlace(place) {
    return this._http.post<any>(`${this.cs.API_ENDPOINT}/gn_commons/places`, place);
  }
  // Supprimer lieu
  deletePlace(idPlace) {
    return this._http.delete<any>(`${this.cs.API_ENDPOINT}/gn_commons/places/${idPlace}`);
  }

  deleteAf(af_id) {
    return this._http.delete<any>(`${this.cs.API_ENDPOINT}/meta/acquisition_framework/${af_id}`);
  }

  publishAf(af_id) {
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/meta/acquisition_framework/publish/${af_id}`
    );
  }

  deleteDs(ds_id) {
    return this._http.delete<any>(`${this.cs.API_ENDPOINT}/meta/dataset/${ds_id}`);
  }
  ...
  getadditionalFields(params?: ParamsDict) {
    ...
    return this._http
      .get<any>(`${this.cs.API_ENDPOINT}/gn_commons/additional_fields`, { params: queryString })
      .pipe(
  ...
  getStatusValues(statusType: String) {
    return this._http.get<any>(`${this.cs.API_TAXHUB}/bdc_statuts/status_values/${statusType}`);
  }

  getProfile(cdRef) {
    return this._http.get<any>(`${this.cs.API_ENDPOINT}/gn_profiles/valid_profile/${cdRef}`);
  }

  getPhenology(cdRef, idNomenclatureLifeStage?) {
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/gn_profiles/cor_taxon_phenology/
...
*/
  getProfileConsistancyData(idSynthese) {
    return this._http.get<any>(
      `${this.cs.API_ENDPOINT}/gn_profiles/consistancy_data/${idSynthese}`
    );
  }

  controlProfile(data) {
    return this._http.post<any>(`${this.cs.API_ENDPOINT}/gn_profiles/check_observation`, data);
  }
  ...
  getStatusType(statusTypes: String[]) {
    ...
    return this._http.get<any>(`${this.cs.API_TAXHUB}/bdc_statuts/status_types`, {
      params: queryString,
    });
  }
}
