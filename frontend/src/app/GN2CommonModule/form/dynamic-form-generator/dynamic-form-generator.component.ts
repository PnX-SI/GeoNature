...
export class GenericFormGeneratorComponent implements OnInit {
  ...
  @Output() onFormControlBuilded = new EventEmitter<boolean>();
  ...
  ngOnInit() {
    ...
    this.onFormControlBuilded.emit(true);
  ...
  hasValueChanged(newValue) {
    return Object.keys(newValue).some(key => newValue[key] !== this.oldValue[key]);
  }
