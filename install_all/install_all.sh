...
sudo apt-get install -y python3 python3-dev python3-setuptools python-pip libpq-dev libgdal1-dev python-gdal python-virtualenv build-essential 2>install_all.log 
