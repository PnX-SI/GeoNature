...
def upgrade():
    ...
    fields_entities = [
        ...
        (
            {
                ...
                "fr_label": "Générer les identifiants SINP (UUID) manquants",
                "mandatory": False,
                "autogenerated": True,
                "display": True,
                "mnemonique": None,
            ...
            },
            {
                id_entity_station: {
                    ...
                    "order_field": -1,
                    "comment": "Générer les UUID des stations et habitats non renseignés dans le fichier source",
                },
                id_entity_habitat: {
                    "id_theme": id_theme_general,
                    "order_field": -1,
        ...
        (
            ...
            },
            {
                id_entity_station: {
                    "id_theme": id_theme_general,
                    "order_field": 0,
                    "comment": "Correspondance champs standard: identifiantStaSINP ou permId (UUID)",
                },
                id_entity_habitat: {
                    "id_theme": id_theme_general,
                    "order_field": 0,
        ...
        (
            {
                "name_field": "id_station_source",
                "fr_label": "Identifiant station d’origine",
                "mandatory": False,
                "autogenerated": False,
                "display": True,
                "mnemonique": None,
                "source_field": "id_station_source",
                "dest_field": "id_station_source",
            },
            {
                id_entity_station: {
                    "id_theme": id_theme_general,
        ...
        (
            {
                ...
                "fr_label": "Identifiant habitat d’origine",
                "mandatory": False,
                "autogenerated": False,
                "display": True,
                "mnemonique": None,
