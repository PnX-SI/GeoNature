...
VALUES(
  ...
  releve.geom_local,
  (to_char(releve.date_min, 'DD/MM/YYYY') || ' ' || to_char(releve.hour_min, 'HH24:MI:SS'))::timestamp,
  (to_char(releve.date_max, 'DD/MM/YYYY') || ' ' || to_char(releve.hour_max, 'HH24:MI:SS'))::timestamp,
...
BEGIN
  ...
  UPDATE gn_synthese.synthese SET
      ...
      date_min = (to_char(NEW.date_min, 'DD/MM/YYYY') || ' ' || to_char(NEW.hour_min, 'HH24:MI:SS'))::timestamp,
      date_max = (to_char(NEW.date_max, 'DD/MM/YYYY') || ' ' || to_char(NEW.hour_min, 'HH24:MI:SS'))::timestamp,
