...
BEGIN
  ...
  UPDATE gn_synthese.synthese SET
      ...
      date_min = date_trunc('day',releve.date_min)+COALESCE(releve.hour_min,'00:00:00'::time)::timestamp,
      date_max = date_trunc('day',releve.date_max)+COALESCE(releve.hour_max,'00:00:00'::time)::timestamp, 
