...
BEGIN
  ...
  UPDATE gn_synthese.synthese SET
      ...
      date_min = date_trunc('day',NEW.date_min)+COALESCE(NEW.hour_min,'00:00:00'::time)::timestamp,
      date_max = date_trunc('day',NEW.date_max)+COALESCE(NEW.hour_max,'00:00:00'::time)::timestamp, 
